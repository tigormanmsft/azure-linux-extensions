...
REM
REM             SQL*Plus should be executed in RESTRICTED LEVEL 2 mode, which means
REM             that commands like HOST and SPOOL are not permitted, but commands
REM             like START are permitted.
REM 
REM             Also, SQL*Plus should not attempt to immediately connect into the
REM             database instance, but instead that should happen within the
REM             pre-script, using the "CONNECT / AS SYSBACKUP" command.
REM ================================================================================
REM
REM ********************************************************************************
...
REM
REM ********************************************************************************
REM Emit messages to standard output using DBMS_OUTPUT package...
REM ********************************************************************************

SET ECHO OFF FEEDBACK OFF TIMING OFF SERVEROUTPUT ON PAGESIZE 100 LINESIZE 130
...
EXEC IF '&&V_STATUS' <> 'OPEN' THEN RAISE NOT_LOGGED_ON; END IF;
...
BEGIN
        ...
        sysbackup.azmessage('INFO - AzBackup pre-script: starting BEGIN BACKUP...');
        --
